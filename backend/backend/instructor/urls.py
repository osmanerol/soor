...
from .views import InstructorListAPIView, InstructorUpdateAPIView, InstructorDetailAPIView, InstructorLastAPIView, InstructorProfileAPIView, InstructorIncreaseBalanceAPIView, InstructorDecreaseBalanceAPIView, InstructorUpdateStatusAPIView
