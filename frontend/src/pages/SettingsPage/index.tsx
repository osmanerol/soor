    ...
    */
    ...
    const handleChange=(event: any)=>{
        if(event.target.files[0]){
            ...
            reader.onloadend = () => {
                store!.instructor.result.instructor.image = reader.result!.toString().split(",")[1];
            }
                                        ...
                                        <form onSubmit={handleSubmit(handleSubmitPersonalChange)}>
                                            ...
                                            <div className="image-update-container">
                                                <div className="image-container mb-3">
                                                    <img src={tempImage === '' ? store!.instructor.result.instructor.image : tempImage} alt="user"/>
                                                </div>
                                    ...
                                    }
                                    {
                                        ...
                                        <div className='remove-account-container'>
                                            ...
                                            <div className="text-center">
                                                <Button text='Hesabı Kapat' showConfirm={true} onClick={deleteProfile} confirmText={'Hesap bilgileriniz silinecektir. İşlemi yapmak istediğinize emin misiniz ?'} className='button delete-button' />
                                            </div>
                                        </div>
                                    }
                                </div>
